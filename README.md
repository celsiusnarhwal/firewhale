...
| `FIREWHALE_LABEL_PREFIX`     | The prefix with which Firewhale labels should begin. Endpoint access will be configurable using the `${LABEL_PREFIX}.read` and `${LABEL_PREFIX}.write` labels.                                                                                                                                                | `firewhale` |
